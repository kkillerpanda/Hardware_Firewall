...
`timescale 1 ps / 1 ps
module hades_mm_interconnect_0 (
		...
		input  wire [127:0] mm_bridge_0_s0_readdata,                                          //                                                           .readdata
		output wire [127:0] mm_bridge_0_s0_writedata,                                         //                                                           .writedata
		output wire [0:0]   mm_bridge_0_s0_burstcount,                                        //                                                           .burstcount
		output wire [15:0]  mm_bridge_0_s0_byteenable,                                        //                                                           .byteenable
	...
	wire  [127:0] mm_bridge_0_s0_agent_m0_readdata;                   // mm_bridge_0_s0_translator:uav_readdata -> mm_bridge_0_s0_agent:m0_readdata
	...
	wire   [15:0] mm_bridge_0_s0_agent_m0_byteenable;                 // mm_bridge_0_s0_agent:m0_byteenable -> mm_bridge_0_s0_translator:uav_byteenable
	...
	wire  [127:0] mm_bridge_0_s0_agent_m0_writedata;                  // mm_bridge_0_s0_agent:m0_writedata -> mm_bridge_0_s0_translator:uav_writedata
	wire          mm_bridge_0_s0_agent_m0_write;                      // mm_bridge_0_s0_agent:m0_write -> mm_bridge_0_s0_translator:uav_write
	wire    [4:0] mm_bridge_0_s0_agent_m0_burstcount;                 // mm_bridge_0_s0_agent:m0_burstcount -> mm_bridge_0_s0_translator:uav_burstcount
	wire          mm_bridge_0_s0_agent_rf_source_valid;               // mm_bridge_0_s0_agent:rf_source_valid -> mm_bridge_0_s0_agent_rsp_fifo:in_valid
	wire  [232:0] mm_bridge_0_s0_agent_rf_source_data;                // mm_bridge_0_s0_agent:rf_source_data -> mm_bridge_0_s0_agent_rsp_fifo:in_data
	...
	wire  [232:0] mm_bridge_0_s0_agent_rsp_fifo_out_data;             // mm_bridge_0_s0_agent_rsp_fifo:out_data -> mm_bridge_0_s0_agent:rf_sink_data
	...
	wire  [129:0] mm_bridge_0_s0_agent_rdata_fifo_src_data;           // mm_bridge_0_s0_agent:rdata_fifo_src_data -> mm_bridge_0_s0_agent_rdata_fifo:in_data
	...
	wire  [231:0] mm_bridge_0_s0_agent_rp_data;                       // mm_bridge_0_s0_agent:rp_data -> router_002:sink_data
	...
	wire  [231:0] mm_bridge_0_s0_burst_adapter_source0_data;          // mm_bridge_0_s0_burst_adapter:source0_data -> mm_bridge_0_s0_agent:cp_data
	...
	wire  [231:0] router_002_src_data;                                // router_002:src_data -> mm_bridge_0_s0_rsp_width_adapter:in_data
	...
	wire  [159:0] mm_bridge_0_s0_rsp_width_adapter_src_data;          // mm_bridge_0_s0_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire  [159:0] cmd_mux_src_data;                                   // cmd_mux:src_data -> mm_bridge_0_s0_cmd_width_adapter:in_data
	...
	wire  [231:0] mm_bridge_0_s0_cmd_width_adapter_src_data;          // mm_bridge_0_s0_cmd_width_adapter:out_data -> mm_bridge_0_s0_burst_adapter:sink0_data
	...
	wire  [129:0] mm_bridge_0_s0_agent_rdata_fifo_out_data;           // mm_bridge_0_s0_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	...
	wire  [129:0] avalon_st_adapter_out_0_data;                       // avalon_st_adapter:out_0_data -> mm_bridge_0_s0_agent:rdata_fifo_sink_data
	...
	hades_mm_interconnect_0_router router (
	...
	hades_mm_interconnect_0_router router_001 (
	...
	hades_mm_interconnect_0_router_002 router_002 (
	...
	hades_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                    //       clk.clk
		.reset              (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hades_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                                    //       clk.clk
		.reset              (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hades_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hades_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                      //       clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
	...
	hades_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                                    //       clk.clk
		.reset               (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hades_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                                    //       clk.clk
		.reset               (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
